...
export default function Navbar() {
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-[1000] isolate h-[4.5rem] border-b border-[#E7E5DE] bg-white md:h-[5.5rem] lg:h-24">
      ...
      <div className="h-[4.5rem] md:h-[5.5rem] lg:h-24" aria-hidden="true" />
    </>
  )
}
